<template>
    <div class="dashboard">
        <v-navigation-drawer class="fullheight" width="200" permanent app fixed>
            <v-list-item>
                <v-list-item-content>
                    <v-list-item-title class="title">Bella</v-list-item-title>
                    <v-list-item-subtitle>190710372</v-list-item-subtitle>
                </v-list-item-content>
            </v-list-item>
